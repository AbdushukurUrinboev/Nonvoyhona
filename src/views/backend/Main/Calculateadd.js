    ...
    return(
        ...
        <Row>
                   ...
                   <div className="d-flex align-items-center justify-content-between">
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb p-0 mb-0">
                                <li className="breadcrumb-item"><Link to="/calculate">Calculate</Link></li>
                                <li className="breadcrumb-item active" aria-current="page">Add Calculate</li>
                            </ol>
                        </nav>
                    </div>
            ...
            <Col lg="12" className="mb-3 d-flex justify-content-between">
                <h4 className="font-weight-bold d-flex align-items-center">Yangi Kalkulyatsiya qo'shish</h4>
            </Col>
            <Col lg="12">
                <Card>
                    <Card.Body>
