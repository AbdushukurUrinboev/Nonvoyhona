        ...
        <>
            <Container fluid>
                <Row>
                        ...
                        <div className="d-flex align-items-center justify-content-between">
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb p-0 mb-0">
                                    <li className="breadcrumb-item"><Link to="/product">Mahsulotlar</Link></li>
                    ...
                    <Col lg="12" className="mt-3 mb-3 d-flex justify-content-between">
                        <Link to="/product" className="btn btn-primary btn-sm d-flex align-items-left justify-content-between">
                                ...
                                <Row>
                                    ...
                                    <Col md="9">
                                        ...
                                        <div className="text-right mt-4">
                                            <Link to="/product" className='btn myButtonProducts qushishProduct' type="button" onClick={handleChange}>
