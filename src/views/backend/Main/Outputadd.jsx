            ...
            <Container>
                <Row>
                            ...
                            <div className="d-flex align-items-center justify-content-between">
                                <nav aria-label="breadcrumb">
                                    <ol className="breadcrumb p-0 mb-0">
                                        ...
                                        <li className="breadcrumb-item active" aria-current="page">Yangi chiqim qo'shish</li>
                                    </ol>
                                </nav>
                            </div>
                    ...
                    <Col lg="12" className="mb-3 d-flex justify-content-between mt-5 outputAddStyle">
                        <h4 className="font-weight-bold d-flex align-items-center">Yangi Chiqimni qo'shish</h4>
                    </Col>
