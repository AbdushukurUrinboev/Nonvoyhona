            ...
            <div className={`iq-sidebar sidebar-default ${variant}`}>
                <div className="iq-sidebar-logo d-flex align-items-end justify-content-between mt-3">
                    <Link to="/" className="header-logo">
                        ...
                        <span style={{ color: '#C37500', fontWeight: '800', fontSize: '36px', lineHeight: '30px' }}>Javdar</span>
                    </Link>
                ...
                <div className="data-scrollbar" data-scroll="1" id="my-scrollbar">
                    <nav className="iq-sidebar-menu">
                        <Accordion as="ul" id="iq-sidebar-toggle" className="side-menu" onSelect={(e) => setActiveMenu(e)}>
                            {
                                (currentUser.role !== 'yopuvchi' && currentUser.role !== 'parkash' && currentUser.role !== 'xamirkash' && currentUser.role !== 'taminotchi' && currentUser.role !== 'sotuvchi') && (
                            ...
                            {
                                (currentUser.role !== 'yopuvchi' && currentUser.role !== 'parkash' && currentUser.role !== 'xamirkash' && currentUser.role !== 'sotuvchi') && (
                            ...
                            {
                                (currentUser.role !== 'yopuvchi' && currentUser.role !== 'parkash' && currentUser.role !== 'xamirkash' && currentUser.role !== 'taminotchi') && (
